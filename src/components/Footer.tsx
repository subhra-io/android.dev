    ...
    <footer className="bg-navy-800 border-t border-navy-600">
      <div className="container-custom py-12">
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="text-center space-y-2">
            <p className="text-navy-400 text-sm font-mono flex items-center justify-center">
              Built with <Heart className="w-4 h-4 mx-1 text-red-400" /> by Subrajit Pandey
            </p>
          ...
          <button
            onClick={scrollToTop}
            className="p-3 bg-navy-600 hover:bg-green-400/20 rounded-full text-navy-300 hover:text-green-400 transition-all duration-300 hover:transform hover:-translate-y-1 group"
      ...
      <div className="border-t border-navy-700 py-4">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center text-xs text-navy-500 space-y-2 md:space-y-0">
            <div>
